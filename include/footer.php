			...
			$("#slider-range").slider({
				...
				slide: function (event, ui) {
					$("#amount").val("$" + ui.values[0] + " - $" + ui.values[1]);
						...
						$.ajax({
							url:'config/getproducts.php',
							type:'POST',
							//async:false,
							data:{val_min:val_min,val_max:val_max},
                         ...
                         $.ajax({
								url:'config/getoil.php',
								type:'POST',
								//async:false,
								data:{val_min:val_min,val_max:val_max},
								success:function(response_data)
								{
		                          $("#oilresp").html(response_data);
								}                       
			     	       });

                          $.ajax({
								url:'config/getpasta.php',
								type:'POST',
								//async:false,
								data:{val_min:val_min,val_max:val_max},
								success:function(response_pasta)
								{
		                          $("#pasta_nodle").html(response_pasta);
								}                       
			     	       });
